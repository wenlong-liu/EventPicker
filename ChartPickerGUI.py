...
class GraphFrame(wx.Frame):
    ...
    def create_main_panel(self):
        ...
        self.axes2 = self.fig.add_subplot(211, sharex = self.axes)
        self.axes.cla()
        self.axes2.cla()
    ...
    def get_data(self, path):
        ...
        self.solute = self.data_points.solute
    ...
    def on_pick(self,event):
        ...
        self.pick_data.append([self.data_points.dates[self.index[0]],self.values[self.index[0]], self.solute[self.index[0]]])
    ...
    def on_button_export_click_event(self, event):
        with open("export.csv","w") as f:
            writer=csv.writer(f)
            writer.writerow(['Date','Flow','Solute'])
